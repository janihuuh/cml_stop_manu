...
getNewBarcodes <- function(barcode){

  ## To make TCRab barcodes compatible with merged seurat-object

  # name <- extractBarcodeName(barcode)
  name        <- paste(strsplit(barcode, "[_]")[[1]][1], strsplit(barcode, "[_]")[[1]][2], sep = "_")
  barcode_raw <- strsplit(barcode, "[_]")[[1]][3]


  ###
  if(name == "batch2_6m"){
    barcode_new <- paste0(barcode_raw, "_2_1_1_1_1_1_1")
  }

  if(name == "batch2_baseline"){
    barcode_new <- paste0(barcode_raw, "_1_1_1_1_1_1_1")
  }

  if(name == "batch2_relapse"){
    barcode_new <- paste0(barcode_raw, "_1_1_1_1_1_1")
  }


  ###
  if(name == "batch3_6m"){
    barcode_new <- paste0(barcode_raw, "_1_1_1_1_1")
  }

  if(name == "batch3_baseline"){
    barcode_new <- paste0(barcode_raw, "_2_1_1_1_1_1")
  }

  if(name == "batch3_relapse"){
    barcode_new <- paste0(barcode_raw, "_2_1_1_1_1")
  }


  ###
  if(name == "batch4_12m"){
    barcode_new <- paste0(barcode_raw, "_2_1_1_1")
  }

  if(name == "batch4_baseline"){
    barcode_new <- paste0(barcode_raw, "_1_1_1_1")
  }

  ###
  if(name == "batch5_12m"){
    barcode_new <- paste0(barcode_raw, "_1_1")
  }

  if(name == "batch5_6m"){
    barcode_new <- paste0(barcode_raw, "_2_1_1")
  }

  if(name == "batch5_baseline"){
    barcode_new <- paste0(barcode_raw, "_1_1_1")
  }

  ###
  if(name == "batch6_relapse"){
    barcode_new <- paste0(barcode_raw, "_1")
  }

  if(name == "batch6_baseline"){
    barcode_new <- paste0(barcode_raw, "_2_1")
  }

  ###
  if(name == "batch7_relapse"){
    barcode_new <- paste0(barcode_raw, "")
  }

  if(name == "batch7_baseline"){
    barcode_new <- paste0(barcode_raw, "_2")
  }
